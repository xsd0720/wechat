...
@interface MusicLinkView : UIView
...
@interface TimelineMsgTypeMusicCell()

@property (nonatomic, strong) MusicLinkView *linkView;

@end

@implementation TimelineMsgTypeMusicCell

- (MusicLinkView *)linkView
{
    if (!_linkView) {
        _linkView = [[MusicLinkView alloc] initWithFrame:CGRectZero];
