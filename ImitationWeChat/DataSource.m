    ...
    return @{
             ...
             requestResult:@[
                     @{
                         ...
                         @"detail":@"宝宝这会多想有条船",
                         @"time":@"1分钟前",
                          WXMessageTypeStr:[NSString stringWithFormat:@"%li", (long)WXMessageTypeText],
                     ...
                     @{
                         ...
                         @"time":@"2分钟前",
                         WXMessageTypeStr:[NSString stringWithFormat:@"%li", (long)WXMessageTypeImage],
                         @"data":@[
                                 @"11111.jpg",
                     ...
                     @{
                         @"image":@"haoyou4.jpg",
                         @"username":@"赵丽颖",
                         @"detail":@"由南派三叔同名小说改编的电视剧《老九门》正在东方卫视热播,女主角赵丽颖在“神隐”八集之后终于登场,一直被吐槽拖沓的剧情也瞬间提速。",
                         @"time":@"1分钟前",
//                         @"mediaType":@"video",
                         WXMessageTypeStr:[NSString stringWithFormat:@"%li", (long)WXMessageTypeImage],
                         @"data":@[
                     ...
                     @{
                         @"image":@"haoyou5.jpg",
                         @"username":@"陈乔恩",
                         @"detail":@"土巴兔成立于2008年，是面向用户的一站式家装服务平台，目前已开通250个城市分站，累计服务1100万中国家庭。在土巴兔，用户可获得免费验房、免费设计与报价、免费监理、建材特卖、品质施工、家居电商等服务，一站式享受品质家装，让您省钱、省心、省时间。",
                         @"time":@"2分钟前",
                         WXMessageTypeStr:[NSString stringWithFormat:@"%li", (long)WXMessageTypeImage],
                         @"data":@[
                                 @"head1.jpg",
                     ...
                     @{
                         @"image":@"haoyou6.jpg",
                         @"username":@"李晨",
                         @"detail":@"台，目前已开通250个城市分站，累计服务1100万中国家庭。在土巴兔，用户可获得免费验房、免费设计与报价、免费监理、建材特卖、品质施工、家居电商等服务，一站式享受品质家装，让您省钱、省心、省时间。",
                         @"time":@"2分钟前",
                         WXMessageTypeStr:[NSString stringWithFormat:@"%li", (long)WXMessageTypeImage],
                         @"data":@[
                                 @"testonly.jpg",
                     ...
                     @{
                         @"image":@"haoyou7.jpg",
                         @"username":@"刘诗诗",
                         @"detail":@"刘诗诗，原名刘诗施，1987年3月10日出生于北京。中国内地影视女演员  ，毕业于北京舞蹈学院芭蕾舞专业2006届本科班。 2004年因为出演《月影风荷》中的女主角叶风荷而踏入演艺圈  。2008年参演《射雕英雄传》  饰演穆念慈，2009年参演《仙剑奇侠传三》饰演龙葵，而被观众所熟知... (更多)",
                         @"time":@"2分钟前",
                         WXMessageTypeStr:[NSString stringWithFormat:@"%li", (long)WXMessageTypeVideo],
                         @"data":@[
                                 @"testonly.jpg",
                                 ]
                         },
                     ...
                     @{
                         @"image":@"haoyou8.jpg",
                         @"username":@"关晓彤",
                         @"detail":@"关晓彤，1997年9月17日出生于北京，学生、演员。2016年4月14日，北影艺考成绩出炉，关晓彤专业排名第一。  2016年6月，关晓彤高考成绩552分，超过艺术类本科文科录取分数线206分。  关晓彤出生于演员世家，2003年出演霍建起导演的电影《暖》上映，该片获2003年度中国电影... (更多)",
                         @"time":@"2分钟前",
                         WXMessageTypeStr:[NSString stringWithFormat:@"%li", (long)WXMessageTypeWeb],
                         @"data":@[
                                 @"testonly.jpg",
                                 ]
                         },
