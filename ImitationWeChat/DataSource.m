    ...
    return @{
             ...
             requestResult:@[
                     @{
                         ...
                         @"detail":@"宝宝这会多想有条船",
                         @"time":@"1分钟前",
                         WXMessageTypeKey:[NSString stringWithFormat:@"%li", (long)WXMessageTypeText],
...
//                         @"mediaType":@"video",
                     ...
                     @{
                         ...
                         @"time":@"2分钟前",
                         WXMessageTypeKey:[NSString stringWithFormat:@"%li", (long)WXMessageTypeVideo],
                         WXMessageTypeDataKey:@[
                                 @"testonly.jpg",
                                 ]
                         },
                     ...
                     @{
                         ...
                         @"detail":@"今天者大雨天有着凉了，闹肚子闹一天，转被窝还直打喷嚏，晚上吃什么呢😄",
                         @"time":@"2分钟前",
                         WXMessageTypeKey:[NSString stringWithFormat:@"%li", (long)WXMessageTypeMusic],
                         WXMessageTypeDataKey:@[
                                 @{
                                     @"image":@"head8.jpg",
                                     @"text":@"可爱女人",
