...
@interface KxMenuOverlay : UIControl
@end
...
//    UIImage *selectedImage = [KxMenuView selectedImage:(CGSize){maxItemWidth, maxItemHeight + 2}];
    ...
    for (KxMenuItem *menuItem in _menuItems) {
        ...
        if (menuItem.enabled) {
            ...
            [button setBackgroundImage:[UIImage ImageWithColor:RGBCOLOR(65, 65, 67) frame:button.bounds] forState:UIControlStateHighlighted];
...
{
    CGFloat R0 = 73/255.0, G0 = 73/255.0, B0 = 75/255.0;
              ...
              menuItems:(NSArray *)menuItems
{
    ...
    else
    {
        ...
        overlay = [[KxMenuOverlay alloc] initWithFrame:view.bounds];
        ...
        [menuView showMenuInView:view fromRect:rect menuItems:menuItems];
              ...
              menuItems:(NSArray *)menuItems
{
    ...
    [[KxMenu sharedMenu] showMenuInView:view fromRect:rect menuItems:menuItems];
